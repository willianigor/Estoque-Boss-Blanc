# ==========================================
# Controle de Estoque — BOSS BLANC
...
def processar_pdf_vendas(pdf_file) -> Tuple[bool, List[dict], str]:
    try:
        ...
        SIZE = r"(?:XGG|GG|XG|PP|GG|G|M|P|16|14|12|10|8|6|4|2)"
        TOKEN = (
            r"(?:[A-Z]{2,}(?:-[A-Z]{2,}){0,2})"
        ...
        size_suffix_re = re.compile(rf"^(.*-)(XGG|GG|XG|PP|GG|G|M|P|16|14|12|10|8|6|4|2)$")
...
# -------- Estoque Atual --------
    ...
    if df.empty:
        ...
        def highlight(row):
            if row["estoque"] < 0:
                return ["background-color: #6b0101" for _ in row]
